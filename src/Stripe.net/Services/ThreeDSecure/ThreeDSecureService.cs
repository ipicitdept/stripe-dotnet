namespace Stripe
{
        ...
        IRetrievable<ThreeDSecure, ThreeDSecureGetOptions>
    {
        ...
        public virtual Task<ThreeDSecure> GetAsync(string id, ThreeDSecureGetOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
