namespace Stripe
{
        ...
        IUpdatable<Customer, CustomerUpdateOptions>
    {
        ...
        public virtual Task<CustomerBalanceTransactionList> BalanceTransactionsAsync(string id, CustomerBalanceTransactionsOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public virtual Task<DeletedDiscount> DeleteDiscountAsync(string id, CustomerDeleteDiscountOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
