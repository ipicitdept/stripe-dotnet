namespace Stripe
{
        ...
        IUpdatable<Source, SourceUpdateOptions>
    {
        ...
        public virtual Task<unknown> DetachAsync(string id, SourceDetachOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
