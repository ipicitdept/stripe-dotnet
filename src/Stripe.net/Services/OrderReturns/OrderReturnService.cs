namespace Stripe
{
        ...
        IRetrievable<OrderReturn, OrderReturnGetOptions>
    {
        ...
        public virtual Task<OrderReturn> GetAsync(string id, OrderReturnGetOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public virtual Task<StripeList<OrderReturn>> ListAsync(OrderReturnListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
