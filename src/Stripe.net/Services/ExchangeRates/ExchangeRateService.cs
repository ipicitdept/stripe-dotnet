namespace Stripe
{
        ...
        IRetrievable<ExchangeRate, ExchangeRateGetOptions>
    {
        ...
        public virtual Task<ExchangeRate> GetAsync(string id, ExchangeRateGetOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
