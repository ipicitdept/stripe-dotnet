namespace Stripe
{
        ...
        IRetrievable<Balance, BalanceGetOptions>
    {
        ...
        public virtual Task<Balance> GetAsync(string id, BalanceGetOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
