namespace Stripe
{
        ...
        IUpdatable<Topup, TopupUpdateOptions>
    {
        ...
        public virtual Task<Topup> CancelAsync(string id, TopupCancelOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
