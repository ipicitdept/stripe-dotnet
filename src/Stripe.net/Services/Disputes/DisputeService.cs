namespace Stripe
{
        ...
        IUpdatable<Dispute, DisputeUpdateOptions>
    {
        ...
        public virtual Task<Dispute> CloseAsync(string id, DisputeCloseOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
