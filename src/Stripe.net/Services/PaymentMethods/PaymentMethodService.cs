namespace Stripe
{
        ...
        IUpdatable<PaymentMethod, PaymentMethodUpdateOptions>
    {
        ...
        public virtual Task<PaymentMethod> AttachAsync(string id, PaymentMethodAttachOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
